...
\IEEEauthorblockN{13 April 2024 (v1.2)}%, xyz i\IEEEauthorrefmark{1} and xyzi \IEEEauthorrefmark{1} and xyzz\IEEEauthorrefmark{1} and xyz\IEEEauthorrefmark{1}}
...
\subsection{Technologies used in Inference Network 1.0}

This subsection delves deeper into describing the technologies utilized in designing Inference Network 1.0.
...
The on-chain component of the Inference Network system acts as the interface for end users and dApps.  Users or dApps submit workloads, which include all necessary details like input, precommitment, and destination. This on-chain architecture consists of three main components: The Inference Market, Model Registry, and Verifier Contracts.
